...
public class BaseAction {
	...
	public  JsonValueProcessor userNameJsonValueProcessor = new  JsonValueProcessor(){
		...
		public Object processObjectValue(String key, Object value,
			...
			return user==null?value:user.getAccountName();   
		}};	
	...
	public  static JsonConfig getJsonConfig(){
		...
		jsonConfig.setJsonPropertyFilter(new PropertyFilter() {
			public boolean apply(Object arg0, String arg1, Object arg2) { 
				if (  arg1.equals("handler") || arg1.equals("hibernateLazyInitializer") || arg1.equals("flowvariables")  )
					return true;
				else
					return false;
			}
...
//			}
	...
	private static final String [] exlude =  new String[]{"taskId","assigneeType","assignee","candidate","activityId","poId","proccessInstanceId"};
	...
	public JsonValueProcessor getUserNameJsonValueProcessor() {
		return userNameJsonValueProcessor;
	}


	public void setUserNameJsonValueProcessor(
			JsonValueProcessor userNameJsonValueProcessor) {
		this.userNameJsonValueProcessor = userNameJsonValueProcessor;
	}
	...
	public void setMaskUserNameJsonValueProcessor(
			JsonValueProcessor maskUserNameJsonValueProcessor) {
