...
<script type="text/javascript">
		...
		<sui:panel title="职务修改" id='updateJob' style="width:100%;margin:0 auto;"
			isToggle="true" isFold="false">
			<sui:validate formId="jobFormUpdate" onclick="jobFormSubmit"
				callback="jobFormCRUD.saveOrUpdate"></sui:validate>
			<form id="jobFormUpdate" method="post"
				action='${ctxPath}/job/jobSave.action'>
				<sui:field type="input">
					<sui:input title="职务名称："  size="x30" require="true"> 
						<input type="text" name='name' value="${jobs.name}" required="true" maxlength="50"/>  
					</sui:input>
