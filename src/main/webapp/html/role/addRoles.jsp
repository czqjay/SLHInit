...
label {
	...
	float: left
		...
		<sui:panel title="角色添加" id='addRole' style="width:100%;margin:0 auto;"
			...
			<sui:validate formId="roleFormAddList" onclick="roleFormSubmit"
				callback="roleFormCRUD.saveToRoleAdd"></sui:validate>
			<form id="roleFormAddList" method="post"
				...
				<sui:field type="button" style="margin-left:10px">
					...
					<sui:button title="取消"
						onclick="suntoolkit.destroyDialog('addRoles')"></sui:button>
				</sui:field>
