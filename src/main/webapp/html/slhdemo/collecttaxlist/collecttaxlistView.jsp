...
label {
	...
	float: left
			...
			<form id="collecttaxlistFormUpdate" method="post" 
				...
				<sui:panel title="缴款书表单信息" id='collecttaxlistUpdate' style="width:100%;margin:0 auto;"
			isToggle="true" isFold="false">
							...
							<sui:field type="input"   >  
								<sui:input title="纳税人号：" size="x30" require='true'  >
							...
							<sui:field type="input"   >  
								<sui:input title="纳税人名称：" size="x30" require='true'  >
							...
							<sui:field type="input"   >  
								<sui:input title="登记类型：" size="x30"   >
																		<sui:select style="width:100px"  id="ctlType" name='ctlType'
							...
							<sui:field type="input"   >  
								<sui:input title="义务人代码：" size="x30" require='true'  >
							...
							<sui:field type="input"   >  
								<sui:input title="义务人名称：" size="x30" require='true'  >
							...
							<sui:field type="input"   >  
								<sui:input title="税款所属于时期：" size="x30"   >
	...
	$(function() {
		//$('#collecttaxlistUpdate *').attr("disabled","disabled") ; 
