...
label {
	...
	float: left
		...
		<sui:panel title="工作技能学习培训意向表修改" id='traningworkerUpdate' style="width:100%;margin:0 auto;"
			isToggle="true" isFold="false">
			<sui:validate formId="traningworkerFormUpdate" onclick="traningworkerFormSubmit" ignore=":hidden" 
				callback="traningworkerFormCRUD.saveOrUpdate"></sui:validate>
			<form id="traningworkerFormUpdate" method="post" 
				action='${ctxPath}/traningworker/traningworkerUpdate.action'>
