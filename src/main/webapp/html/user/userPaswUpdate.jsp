...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	<head>
		...
		<script type='text/javascript' src='${ctxPath}/html/user/js/userPaswUpdate.js'></script>
		...
		<sui:panel title="用户密码修改" id='personPaswUpdate' style="width:100%;margin:0 auto;"
			...
			<form id="personPaswUpdateForm" method="post"
				...
				<sui:field type="hidden">
		 			<input type="hidden" id="accountName" name="accountName" value="${param.accountName}" /> 
